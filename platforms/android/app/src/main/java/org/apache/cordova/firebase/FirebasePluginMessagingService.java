...
public class FirebasePluginMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(String refreshedToken) {
        try{
            ...
            CleverTapAPI.getDefaultInstance(getApplicationContext()).pushFcmRegistrationId(refreshedToken,true);
        }catch (Exception e){
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        try{
            ...
            if (info.fromCleverTap) {
                CleverTapAPI.createNotificationChannel(getApplicationContext(),"TEST","Game of Thrones","Game Of Thrones",NotificationManager.IMPORTANCE_MAX,true);
